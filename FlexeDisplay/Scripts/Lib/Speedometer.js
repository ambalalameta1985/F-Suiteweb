...
$.fn.speedometer = function (userPref) {
  ...
  this.defaultProperty = {
	...
	speedUnitTxtWH  	: 50,          /**speedo-meter current value cont*/
  ...
  speedUnitTxtWH = this.defaultProperty.edgeRadius - this.defaultProperty.speedUnitTxtWH/2,
  tempDiv       = '',
  ...
  this.creatHtmlsElecments = function(){
	...
	this.gauges = $('.gauge-control'); 
    this.parentElemId = 'speedometerWraper-' + (this.gauges.index(this) + 1);
    $(this).wrap('<div id="'+ this.parentElemId +'">');
    this.parentElem = $(this).parent();
    this.setCssProperty();
    this.createIndicators();
	$('.speedUnit',this[0].parentNode).text($(this).attr('unit'));
  }
